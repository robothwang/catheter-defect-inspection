...
from DenseNet121 import CLASS_NAMES, build_densenet121, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class DenseNet121 classifier")
    ...
    model, _ = build_densenet121(num_classes=len(class_names), pretrained=False)
