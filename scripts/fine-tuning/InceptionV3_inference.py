...
from InceptionV3 import CLASS_NAMES, build_inception_v3, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class Inception-V3 classifier")
    ...
    image_size = int(checkpoint.get("image_size", 299))

    model, _ = build_inception_v3(num_classes=len(class_names), pretrained=False)
