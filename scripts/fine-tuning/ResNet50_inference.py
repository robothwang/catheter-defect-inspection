...
from ResNet50 import CLASS_NAMES, build_resnet50, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class ResNet50 classifier")
    ...
    model, _ = build_resnet50(num_classes=len(class_names), pretrained=False)
