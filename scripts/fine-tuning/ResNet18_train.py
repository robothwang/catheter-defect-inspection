...
def make_default_split_path(seed: int) -> Path:
    return Path("/home/hjj747/catheter-preprocessing/experiments/splits") / f"resnet18_3class_seed{seed}.csv"
...
def main():
    parser = argparse.ArgumentParser(description="ResNet18 fine-tuning for catheter 3-class classification")
    ...
    output_dir = args.output_dir or (
        Path("/home/hjj747/catheter-preprocessing/experiments") / f"resnet18_{args.dataset_type}"
    )
    ...
    model, weights = build_resnet18(num_classes=len(CLASS_NAMES), pretrained=True)
