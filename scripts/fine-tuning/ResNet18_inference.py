...
from ResNet18 import CLASS_NAMES, build_resnet18, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class ResNet18 classifier")
