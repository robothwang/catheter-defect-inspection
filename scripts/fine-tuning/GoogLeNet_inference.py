...
from GoogLeNet import CLASS_NAMES, build_googlenet, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class GoogLeNet classifier")
    ...
    model, _ = build_googlenet(num_classes=len(class_names), pretrained=False)
