...
from MobileNetv2 import CLASS_NAMES, build_mobilenetv2, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class MobileNetV2 classifier")
    ...
    model, _ = build_mobilenetv2(num_classes=len(class_names), pretrained=False)
