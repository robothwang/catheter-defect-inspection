...
from DenseNet201 import CLASS_NAMES, build_densenet201, build_transform, load_image
...
def main():
    parser = argparse.ArgumentParser(description="Inference for catheter 3-class DenseNet201 classifier")
    ...
    model, _ = build_densenet201(num_classes=len(class_names), pretrained=False)
