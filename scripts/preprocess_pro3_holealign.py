...
def main():
    ...
    parser.add_argument(
        "--template",
        type=Path,
        default=Path("/home/hjj747/catheter-defect-inspection/data/raw/label_orign/pro_3_endpoint.png"),
        help="기준 템플릿 이미지",
    )
    parser.add_argument(
        "--output-dir",
